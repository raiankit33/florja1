...
@Component({
  selector: 'app-tenant-forget',
  templateUrl: './tenant-forget.component.html',
  styleUrls: ['./tenant-forget.component.css']
})
export class TenantForgetComponent implements OnInit {
  constructor(
