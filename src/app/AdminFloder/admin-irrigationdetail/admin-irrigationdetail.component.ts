...
@Component({
  selector: 'app-admin-irrigationdetail',
  templateUrl: './admin-irrigationdetail.component.html',
  styleUrls: ['./admin-irrigationdetail.component.css']
})
export class AdminIrrigationdetailComponent implements OnInit {
